 ...
 * Constructor.
 */
FishModelBase::FishModelBase(FishBot* robot, ControlModeType::Enum type)
      ...
      m_targetUpdateTimer()
{
    ...
    connect(&RobotControlSettings::get(), &RobotControlSettings::notifyFishModelSettingsChanged,
        this, &FishModelBase::updateModelParameters);
}

/*!
 * Destructor.
 */
FishModelBase::~FishModelBase()
{
 ...
 */
QList<ControlTargetType> FishModelBase::supportedTargets()
{
 ...
 */
PositionMeters FishModelBase::computeTargetPosition()
{
    if (m_sim == nullptr) {
 ...
 * model is reset.
 */
void FishModelBase::setParameters(ModelParameters parameters)
{
